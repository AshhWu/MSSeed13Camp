...
<script type="text/javascript">
	...
	for (i = 2; i < len; i+=5){
		if (msg[i] == 0)
			str += '<p class="w3-card-4 w3-padding w3-light-grey" style="float:right">' + msg[i+1] + '</p><br><br>';
		else if (msg[i] == 1)
			str += '<p class="w3-card-4 w3-padding w3-light-grey" style="float:left">' + msg[i+1] + '</p><br><br>';
	}
