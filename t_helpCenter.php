...
<h5 class="w3-card-2 w3-orange w3-padding" style="width:250px;margin:auto;">小提醒1:越靠頁面上方的訊息越新<br>小提醒2:如想看新回覆請手動刷新頁面.</h5>
...
<script type="text/javascript">
	...
	for (i = len-4; i > 0; i-=5){
		if (msg[i] == 0)
			str += '<p class="w3-card-2 w3-blue w3-padding-small w3-round" style="float:right;max-width:250px;">' + msg[i+1] + '</p><br><br>';
		else if (msg[i] == 1)
			str += '<p class="w3-card-2 w3-light-grey w3-padding-small w3-round" style="float:left;max-width:250px;">' + msg[i+1] + '</p><br><br>';
	}
