...
<script type="text/javascript">
	...
	for (i = len-4; i > 0; i-=5){
		if (msg[i] == 0)
			str += '<p class="w3-card-2 w3-blue w3-padding w3-round" style="float:right;max-width:250px;margin-top:8px;">' + msg[i+1] + '</p><br><br>';
		else if (msg[i] == 1)
			str += '<p class="w3-card-2 w3-light-grey w3-padding w3-round" style="float:left;max-width:250px;margin-top:8px;">' + msg[i+1] + '</p><br><br>';
	}
