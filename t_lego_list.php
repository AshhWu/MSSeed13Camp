...
<div class="container">
	<ul class="nav nav-tabs">
		...
		<li><a data-toggle="tab" href="#wait_list" onclick="wait_init('[' + <?php foreach($wait as $arr){echo '['; foreach($arr as $value){echo $value . ',';} ']';}?> + ']')">已提交易</a></li>
	</ul>
	...
	<div class="tab-content">
		...
		<div id="wait_list" class="tab-pane fade w3-container w3-section w3-padding">
			<h4 class="w3-card w3-pink w3-padding">你向別組提出的交易<br><?php foreach($wait as $arr){echo '['; foreach($arr as $value){echo $value . ',';} echo ']';}?></h4>
